...
#    Dockerfile                                         :+:      :+:    :+:    #
#                                                     +:+ +:+         +:+      #
#    By: alaguila <marvin@42.fr>                    +#+  +:+       +#+         #
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2020/01/09 15:38:01 by alaguila          #+#    #+#              #
#    Updated: 2020/01/10 11:10:23 by aortega-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
COPY srcs/wordpress /var/www/aortega-/html/wordpress
COPY srcs/config_nginx /etc/nginx/sites-available/
COPY srcs/phpMyAdmin /var/www/aortega-/html/phpmyadmin
COPY srcs/index.html /var/www/aortega-/html
